namespace TestHarvester.Db
{
    ...
    public class SecretManagerHelper
    {
        ...
        private static T ObjectToGeneric<T>(object objReturnValue)
        {
            ...
            if (!ReferenceEquals(tReturnType, typeof(byte[])))
            {
            ...
            try
            {
                ...
                if (ReferenceEquals(tReturnType, typeof(object)))
                {
                    return InlineTypeAssignHelper<T>(objReturnValue);
                }
                else if (ReferenceEquals(tReturnType, typeof(string)))
                {
                    return InlineTypeAssignHelper<T>(strReturnValue);
                } // End if string
                else if (ReferenceEquals(tReturnType, typeof(bool)))
                {
                ...
                else if (ReferenceEquals(tReturnType, typeof(byte[])))
                {
                ...
                else if (ReferenceEquals(tReturnType, typeof(System.Guid)))
                {
                ...
                else if (ReferenceEquals(tReturnType, typeof(System.DateTime)))
                {
